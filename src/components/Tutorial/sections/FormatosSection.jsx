...
export default function FormatosSection() {
  return (
    <TutorialSection
      ...
      description="Al crear una jornada dentro de un torneo, elegís el formato de juego. Cada formato tiene reglas y una dinámica distinta."
    >
      <div className="flex flex-col gap-8 mb-8">
        <div>
          ...
          <p className="text-content text-[14px] font-sans leading-relaxed mb-4">
            Los jugadores se agrupan en parejas para cada jornada (que pueden cambiar de jornada en jornada). Se juegan partidos entre parejas y los puntos se acumulan en una tabla de posiciones general del torneo. Es ideal para grupos de amigos que juegan regularmente.
          </p>
          <ul className="flex flex-col gap-2 mb-4">
            {[
              'No importa si son jugadores pares o impares.',
              'Las parejas se forman libremente para cada jornada.',
              'Los resultados suman puntos a la tabla general del torneo.',
              'Podés agregar, editar o eliminar parejas por jornada.',
            ].map((item, i) => (
          ...
          <TutorialMedia caption="Vista de agregado de jugadores en Modo Liga" src={'https://res.cloudinary.com/dm80qflwa/image/upload/v1775422828/crear-jornada-liga_yxngkf.png'} aspect='aspect-auto'/>
        ...
        <div className="border-t border-border pt-8">
          ...
          <ul className="flex flex-col gap-2 mb-4">
            {[
              ...
              'El torneo se resuelve en una sola jornada.',
            ].map((item, i) => (
              <li key={i} className="flex gap-3 items-start text-[14px] text-secondary font-sans">
                <span className="text-brand mt-0.5 shrink-0">›</span>
                {item}
          ...
          <TutorialMedia caption="Vista de agregado de parejas en Modo Americano" src={'https://res.cloudinary.com/dm80qflwa/image/upload/v1775422827/crear-jornada-americano_g7rv88.png'} aspect='aspect-auto'/>
